...
<!-- FORM-->
  <div>
          <form method="post" action="validation_donor.php">
        ...
        <div class="input-group">
            <button type="submit" class="btn btn-primary"name="login_user" >Login</button><br>
             <a href="register-donor.php">Dont have an account? Click here.</a>
          </form>
  <!-- FORM-->
