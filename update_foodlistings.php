...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE tbl_foodlistings set Food_Listings_id='" . $_POST['Food_Listings_id'] . "', Supplier_id='" . $_POST['S_id'] . "', Food='" . $_POST['Food'] . "', Description='" . $_POST['desc'] . "', Quantity='" . $_POST['Quantity'] . "' , dateposted='" . $_POST['date'] . "',status='" . $_POST['status'] . "' WHERE Food_Listings_id='" . $_POST['Food_Listings_id'] . "'");
$message = "Record Modified Successfully";
header('location: donor_profile.php');
}
$result = mysqli_query($conn,"SELECT * FROM tbl_foodlistings WHERE Food_Listings_id='" . $_GET['id'] . "'");
                ...
                <div class="card-body pt-0">
                    <div class="table-responsive">
                         ...
                         <form name="frmUser" method="post" action="">
                            ...
                            Edit your food listing: <br>

                            <label>ID's</label>
                            <input type="hidden" name="Food_Listings_id" class="txtField" value="<?php echo $row["Food_Listings_id"]; ?>" >
                            <input type="text" name="Food_Listings_id"  value="<?php echo $row['Food_Listings_id']; ?>" Disabled>
                            <br>
                            <input type="hidden" name="S_id" class="txtField" value="<?php echo $row["Supplier_id"]; ?>">
                            <input type="text" name="S_id"  value="<?php echo $row['Supplier_id']; ?>"Disabled>
                            <br>

                            Food :<br>
                            <input type="text" name="Food" class="txtField" value="<?php echo $row['Food']; ?>">
                            <br>
                            Description of the food:<br>
                            ...
                            <input type="text" name="status"  value="<?php echo $row['status']; ?>" Disabled>
                            <br>
                            Date posted:
                            <input type="hidden" name="date" class="txtField" value="<?php echo $row["dateposted"]; ?>">
                            <input type="text" name="date"  value="<?php echo $row['dateposted']; ?>" Disabled>
                            <br>
                            <input type="submit" name="submit" value="Submit" class="btn bg-gradient-primary mt-4 w-20" href="javascript:;">
