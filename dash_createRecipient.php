        ...
        <div class="container-fluid pt-3">
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    <form action="insert-recipient2.php" method="post">
				        <div class="row mb-3">
				        ...
				        <div class="row mb-3">
				          ...
				          <button type="submit" value="Submit" class="btn btn-primary" style="color-background:orange;">Register</button>
				        </div>
