                ...
                <div class="card-body pt-0">
                    <div class="table-responsive">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Create new Recipient admin.</p>
                                <a href="dash_createRecipient.php" class="btn btn-primary">Create user</a>
                              </div>
                              <div class="card-body">
                                <h5 class="card-title">Create</h5>
                                <p class="card-text">Create new donor admin.</p>
                                <a href="dash_createDonor.php" class="btn btn-primary">Create user</a>
                              </div>


                              <div class="card-body">
                                <h5 class="card-title">Deactivate</h5>
                                <p class="card-text">Deactivate Recipient admin.</p>
                                <a href="#" class="btn btn-primary">Deactivate user</a>
                              </div>
                              <div class="card-body">
                                <h5 class="card-title">Deactivate</h5>
                                <p class="card-text">Deactivate Donor admin.</p>
                                <a href="#" class="btn btn-primary">Deactivate user</a>
                              </div>
