                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                         ...
                         <tr>
                          ...
                          <td><?php echo $row['donations_made']??''; ?></td>
                        ...
                        <tbody>
                         ...
                         while($data=mysqli_fetch_array($result)){
                            ...
                            $query = "SELECT * FROM tbl_foodlistings WHERE( Supplier_id='$user_id' AND status = '1') ";
                         ...
                         <tr>
                          ...
                          <td>
                            ...
                            <a href="FL_delete.php?id=<?php echo $row['Food_Listings_id']; ?>" >

                            <i class="fa fa-trash-o" ></i> Delete

                            </a>
                            <a href="update_foodlistings.php?id=<?php echo $row['Food_Listings_id']; ?>">
                     ...
                     <div class="table-responsive">
                        ...
                        <tbody>
                         ...
                         while($data=mysqli_fetch_array($result)){
                            ...
                            $query = "SELECT * FROM tbl_donations WHERE( Supplier_id='$user_id' AND status = 1) ";
                            $result = mysqli_query($conn, $query);
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            © 2022,
                            made with
                            <a href="https://www.creative-tim.com/product/material-dashboard" class="font-weight-bold text-capitalize" target="_blank">Material Dashboard</a> &amp;
